...
##########################################################################################
	package = ["com.tencent.mm","com.vipshare","com.eg.android.AlipayGphone","com.taobao.taobao","com.qqgame.hlddz","com.tencent.mobileqqi","com.tencent.mobileqq","com.speedsoftware.rootexplorer","com.sina.weibo","com.android.chrome","tv.danmaku.bili","com.baidu.netdisk","com.android.vending","mark.via","com.baidu.BaiduMap","com.zhihu.android","com.sankuai.meituan","com.xfplay.play","cn.wps.moffice_eng","com.netease.cloudmusic"]
	if req.command=='GET' and 'dl?pn=' in req.path:
		for pk in package:
			#print pk
			if pk in req.path:	
				fp=open('proxyconfig.ini','r')
				line=fp.readline().split()[0]
				#print line+pk+'.apk'
				self.wfile.write("%s %d %s\r\n" % (self.protocol_version, 302, 'Found'))
        			self.send_header('Location', line+pk+'.apk')
        			self.end_headers()
				return
